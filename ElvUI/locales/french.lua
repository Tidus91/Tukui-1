...
do
	...
	L["You are now finished with the installation process. Bonus Hint: If you wish to access blizzard micro menu, middle click on the minimap. If you don't have a middle click button then hold down shift and right click the minimap. If you are in need of technical support please visit us at www.tukui.org."] = "Vous avez maintenant terminé le processus d'installation. Astuce : Si vous désirez accèder au mini menu, cliquez avec le bouton central de votre souris sur la minicarte. Si vous n'avez pas de bouton central, maintenez la touche Shift enfoncée et cliquez-droit sur la minicarte. Si vous avez besoin d'un support technique, merci de vous rendre sur www.tukui.org.";
